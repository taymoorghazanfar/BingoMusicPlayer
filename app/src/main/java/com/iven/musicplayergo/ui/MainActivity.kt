...
class MainActivity : AppCompatActivity(), UIControlInterface, MediaControlInterface {
    ...
    private val connection = object : ServiceConnection {
        override fun onServiceConnected(componentName: ComponentName, service: IBinder) {
            ...
            mMediaPlayerHolder = mPlayerService.mediaPlayerHolder.apply {
                ...
                onHandleNotificationColorUpdate(
    ...
    private fun loadBannerAd() {
        val bannerAdView = findViewById<View>(R.id.adView) as AdView
        ...
        with(mPlayerControlsPanelBinding.favoritesButton) {
            safeClickListener {
                if (!goPreferences.favorites.isNullOrEmpty()) {
                    RecyclerSheet.newInstance(GoConstants.FAV_TYPE)
    ...
    override fun onPlaybackSpeedToggled() {
        ...
        val isPlaybackPersisted =
            goPreferences.playbackSpeedMode != GoConstants.PLAYBACK_SPEED_ONE_ONLY
        mMediaPlayerHolder.setPlaybackSpeed(
    ...
    private val mMediaPlayerInterface = object : MediaPlayerInterface {
        ...
        override fun onBackupSong() {
            if (checkIsPlayer(showError = false) && !mMediaPlayerHolder.isPlaying) {
                goPreferences.latestPlayedSong = mMediaPlayerHolder.currentSong?.toSavedMusic(
